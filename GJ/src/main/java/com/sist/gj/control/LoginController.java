...
public class LoginController {
	...
	@ResponseBody
	public String select(@ModelAttribute UserVO invo, HttpServletRequest req, Model model)
	...
	public String moveMain(HttpSession ses, HttpServletRequest req, Model model)
			throws ClassNotFoundException, SQLException {
		log.info("=====================INSERT=======================");
	...
	public String findIdPass(@ModelAttribute UserVO invo, HttpSession ses, HttpServletRequest req, Model model)
			throws ClassNotFoundException, SQLException {
		log.info("=====================SELECT=======================");
	...
	@ResponseBody
	public String findId(@ModelAttribute UserVO invo, HttpServletRequest req, Model model)
			throws ClassNotFoundException, SQLException {
		log.info("=====================INSERT=======================");
		log.info("invo" + invo);
	...
	@ResponseBody
	public String findPass(@ModelAttribute UserVO invo, HttpServletRequest req, Model model)
			throws ClassNotFoundException, SQLException {
		log.info("=====================findPass=======================");
		log.info("invo" + invo);
	...
	@ResponseBody
	public String checkId(@ModelAttribute UserVO invo, HttpServletRequest req, Model model)
			throws ClassNotFoundException, SQLException {
		log.info("=====================checkid=======================");
		log.info("invo" + invo);
	...
	@ResponseBody
	public String insertId(@ModelAttribute UserVO invo, HttpServletRequest req, Model model)
			throws ClassNotFoundException, SQLException {
		log.info("=====================insertId=======================");
		log.info("invo" + invo);
	...
	@ResponseBody
	public String insertId2(@ModelAttribute UserVO invo, HttpServletRequest req, Model model)
	...
	public String logout(@ModelAttribute UserVO invo, HttpServletRequest req, Model model, HttpSession session)
			throws ClassNotFoundException, SQLException, ParseException {
