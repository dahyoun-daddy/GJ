    ...
    <nav class="navbar navbar-expand-lg navbar-dark cyan">
       ...
       <!-- 기업 상세정보 -------------------------------  -->
		...
		<div class="col-xl-12 col-lg-12 mx-auto">
				...
				<div style="border: 1px solid red; float: left; height:50px; width: 60%;">
					<label>경기도 고양시 일산동구 중산로 101 하늘마을</label>
					</br>
					<label>010-6889-6689 </label>	
				</div>
				<div style="border: 1px solid red; float: right; height:17px; width: 20%;">	
				</div>
				<div style="border: 1px solid red; float: right; height:33px; width: 20%;">
					<button style="float: right;" type="button" class="btn btn-danger btn-sm">면접 리뷰 작성하기</button>
				</div>
   			<!-- 면접리뷰 -------------------------------  -->
				...
				<div style="border: 1px solid red; background-color:#ECF6CE; float: left; height:30px; width: 20%;">
					...
					<button style="float: right;" type="button" class="btn btn-danger btn-sm">수정하기</button>
				</div>
