	...
	<jsp:include page="../common/top.jsp" flush="false"></jsp:include>
	 <!--기업 회원가입 폼 -->
        	...
        	<input type="password" id="pw" name="pw" placeholder="비밀번호 입력 조건">
     		...
     		<label><b>비밀번호 확인</b></label>
       		<input type="password" id="pw2" name="pw2" placeholder="다시 입력하세요">
      			<br><br>
      			<label><b>기업명</b></label>
	        <input type="text" id="nick"name="nick" placeholder="기업명을 입력하세요">
	        	<br><br>
	       	<label><b>대표자</b></label>
	        <input type="text" id="name"name="name" placeholder="대표자을 입력하세요">
	        	<br><br>
	         <label><b>회사 전화번호</b></label>
	        <input type="text" id="pn"name="pn" placeholder="ex) 02-0000-0000">
	       		<br><br>
	       	<label><b>회사 주소</b></label> 
	        <input type="text"id="ad"name="ad" placeholder="회사 주소를 입력하세요">
	       		<br><br>
	       	<label><b>매출액</b></label> 
	       	<input type="text"id="salay"name="salay" placeholder="매출액을 입력하세요">
	       		<br><br>
	       	<label><b>사원수</b></label> 
	       	<input type="text"id="cnt"name="cnt" placeholder="사원수를 입력하세요">
	       		<br><br>
	       		<label><b>설립일</b></label> 
	       	<input type="text"id="hire"name="hire" placeholder="ex 1990-05-05">
	       		<br><br>
	      <label><b>비밀번호 찾기 질문:</b></label>
	        ...
	        <input type="text" id="passA"name="passA" placeholder="10글자 이하 입력">
	       		<br><br>
	        ...
	        <!-- <input type="submit" name="submit" value="회원가입" onclick="javascript:do_insert()"> >-->
	         <button class="btn btn-primary" type="button" id="reset"name="reset">초기화</button>
			  <button class="btn btn-primary" type="button" id="insertId" name="insertId">회원가입</button>
			<br>
