...
<body>
	<jsp:include page="../common/top.jsp" flush="false"></jsp:include>
	 ...
	 <!--id,pw찾기 폼 -->
	     ...
	     <%=StringUtill.makeSelectBox(signup_q, userPassQu, "userPassQu", false) %><br><br>
	      	<label><b>비밀번호 찾기 답변</b></label> 
	        <input type="text" id="an" name="an" placeholder="10글자 이하 입력"> 
	       		<br><br>
	         	 <input type="button" value="비밀번호 찾기" id="findPw" name="findPw">
	       </form>
