...
<body>
	<jsp:include page="../common/top.jsp" flush="false"></jsp:include>
	 <!--구직자 회원가입 폼 -->
	        ...
	        <input type="text" id="pn"name="pn" placeholder="ex) 010-0000-0000">
	       		<br><br>
	       	<label><b>주소</b></label> 
	        <input type="text"id="ad"name="ad" placeholder="주소를 입력하세요">
	       		<br><br>
      ...
      <script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("#insertId").on("click",function(){
				...
				alert("닉네임을 2자이상 20자 이하로 입력해주세요")
				return ;
				}
